...
public:
    DeleteMultipleObjectsUnparker(DeleteMultipleObjectsOutput *
                                  output):QsDefaultResponseUnparker(output)
    {
    };
...
{
public:
    ListObjectsUnparker(ListObjectsOutput *
                        output):QsDefaultResponseUnparker(output)
    {
    };
...
{
public:
    GetObjectUnparker(GetObjectOutput *
                      output):QsDefaultResponseUnparker(output)
    {
    };
...
{
public:
    HeadObjectUnparker(HeadObjectOutput *
                       output):QsDefaultResponseUnparker(output)
    {
    };
...
{
public:
    PutObjectUnparker(PutObjectOutput *
                      output):QsDefaultResponseUnparker(output)
    {
    };
